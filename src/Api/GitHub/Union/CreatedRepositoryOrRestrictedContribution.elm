...
module Api.GitHub.Union.CreatedRepositoryOrRestrictedContribution exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.GitHub.Union.CreatedRepositoryOrRestrictedContribution
