...
module Api.GitHub.Union.CreatedPullRequestOrRestrictedContribution exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.GitHub.Union.CreatedPullRequestOrRestrictedContribution
