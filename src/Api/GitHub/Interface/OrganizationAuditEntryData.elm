...
module Api.GitHub.Interface.OrganizationAuditEntryData exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.GitHub.Interface.OrganizationAuditEntryData
...
-}
organization : SelectionSet decodesTo Api.GitHub.Object.Organization -> SelectionSet (Maybe decodesTo) Api.GitHub.Interface.OrganizationAuditEntryData
...
-}
organizationName : SelectionSet (Maybe String) Api.GitHub.Interface.OrganizationAuditEntryData
organizationName =
...
-}
organizationResourcePath : SelectionSet (Maybe Api.GitHub.ScalarCodecs.Uri) Api.GitHub.Interface.OrganizationAuditEntryData
...
-}
organizationUrl : SelectionSet (Maybe Api.GitHub.ScalarCodecs.Uri) Api.GitHub.Interface.OrganizationAuditEntryData
organizationUrl =
