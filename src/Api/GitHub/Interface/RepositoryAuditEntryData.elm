...
module Api.GitHub.Interface.RepositoryAuditEntryData exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.GitHub.Interface.RepositoryAuditEntryData
...
-}
repository : SelectionSet decodesTo Api.GitHub.Object.Repository -> SelectionSet (Maybe decodesTo) Api.GitHub.Interface.RepositoryAuditEntryData
repository object_ =
...
-}
repositoryName : SelectionSet (Maybe String) Api.GitHub.Interface.RepositoryAuditEntryData
repositoryName =
...
-}
repositoryResourcePath : SelectionSet (Maybe Api.GitHub.ScalarCodecs.Uri) Api.GitHub.Interface.RepositoryAuditEntryData
...
-}
repositoryUrl : SelectionSet (Maybe Api.GitHub.ScalarCodecs.Uri) Api.GitHub.Interface.RepositoryAuditEntryData
repositoryUrl =
