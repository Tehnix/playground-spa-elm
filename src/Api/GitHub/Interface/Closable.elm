...
module Api.GitHub.Interface.Closable exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.GitHub.Interface.Closable
...
-}
closed : SelectionSet Bool Api.GitHub.Interface.Closable
closed =
...
-}
closedAt : SelectionSet (Maybe Api.GitHub.ScalarCodecs.DateTime) Api.GitHub.Interface.Closable
closedAt =
