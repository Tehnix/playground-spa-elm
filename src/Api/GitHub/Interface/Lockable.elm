...
module Api.GitHub.Interface.Lockable exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.GitHub.Interface.Lockable
...
-}
activeLockReason : SelectionSet (Maybe Api.GitHub.Enum.LockReason.LockReason) Api.GitHub.Interface.Lockable
activeLockReason =
...
-}
locked : SelectionSet Bool Api.GitHub.Interface.Lockable
locked =
