...
module Api.GitHub.Interface.GitObject exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.GitHub.Interface.GitObject
...
-}
abbreviatedOid : SelectionSet String Api.GitHub.Interface.GitObject
abbreviatedOid =
...
-}
commitResourcePath : SelectionSet Api.GitHub.ScalarCodecs.Uri Api.GitHub.Interface.GitObject
commitResourcePath =
...
-}
commitUrl : SelectionSet Api.GitHub.ScalarCodecs.Uri Api.GitHub.Interface.GitObject
commitUrl =
...
id : SelectionSet Api.GitHub.ScalarCodecs.Id Api.GitHub.Interface.GitObject
id =
...
{-| The Git object ID
-}
oid : SelectionSet Api.GitHub.ScalarCodecs.GitObjectID Api.GitHub.Interface.GitObject
oid =
...
-}
repository : SelectionSet decodesTo Api.GitHub.Object.Repository -> SelectionSet decodesTo Api.GitHub.Interface.GitObject
repository object_ =
