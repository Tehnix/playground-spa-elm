...
module Api.GitHub.Interface.Updatable exposing (..)
...
fragments :
    Fragments decodesTo
    -> SelectionSet decodesTo Api.GitHub.Interface.Updatable
...
-}
viewerCanUpdate : SelectionSet Bool Api.GitHub.Interface.Updatable
viewerCanUpdate =
