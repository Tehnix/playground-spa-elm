...
module Api.GitHub.InputObject exposing (..)

import Api.GitHub.Enum.ActionExecutionCapabilitySetting
import Api.GitHub.Enum.AuditLogOrderField
import Api.GitHub.Enum.CommitContributionOrderField
import Api.GitHub.Enum.ContributionOrderField
import Api.GitHub.Enum.DeploymentOrderField
import Api.GitHub.Enum.EnterpriseAdministratorInvitationOrderField
import Api.GitHub.Enum.EnterpriseAdministratorRole
import Api.GitHub.Enum.EnterpriseDefaultRepositoryPermissionSettingValue
import Api.GitHub.Enum.EnterpriseEnabledDisabledSettingValue
import Api.GitHub.Enum.EnterpriseEnabledSettingValue
import Api.GitHub.Enum.EnterpriseMemberOrderField
import Api.GitHub.Enum.EnterpriseMembersCanCreateRepositoriesSettingValue
import Api.GitHub.Enum.EnterpriseMembersCanMakePurchasesSettingValue
import Api.GitHub.Enum.EnterpriseOrderField
import Api.GitHub.Enum.EnterpriseServerInstallationOrderField
import Api.GitHub.Enum.EnterpriseServerUserAccountEmailOrderField
import Api.GitHub.Enum.EnterpriseServerUserAccountOrderField
import Api.GitHub.Enum.EnterpriseServerUserAccountsUploadOrderField
import Api.GitHub.Enum.GistOrderField
import Api.GitHub.Enum.IssueOrderField
import Api.GitHub.Enum.IssueState
import Api.GitHub.Enum.LabelOrderField
import Api.GitHub.Enum.LanguageOrderField
import Api.GitHub.Enum.LockReason
import Api.GitHub.Enum.MilestoneOrderField
import Api.GitHub.Enum.OrderDirection
import Api.GitHub.Enum.OrganizationOrderField
import Api.GitHub.Enum.ProjectOrderField
import Api.GitHub.Enum.ProjectState
import Api.GitHub.Enum.ProjectTemplate
import Api.GitHub.Enum.PullRequestMergeMethod
import Api.GitHub.Enum.PullRequestOrderField
import Api.GitHub.Enum.PullRequestReviewEvent
import Api.GitHub.Enum.PullRequestUpdateState
import Api.GitHub.Enum.ReactionContent
import Api.GitHub.Enum.ReactionOrderField
import Api.GitHub.Enum.RefOrderField
import Api.GitHub.Enum.ReleaseOrderField
import Api.GitHub.Enum.ReportedContentClassifiers
import Api.GitHub.Enum.RepositoryInvitationOrderField
import Api.GitHub.Enum.RepositoryOrderField
import Api.GitHub.Enum.RepositoryVisibility
import Api.GitHub.Enum.SavedReplyOrderField
import Api.GitHub.Enum.SecurityAdvisoryIdentifierType
import Api.GitHub.Enum.SecurityAdvisoryOrderField
import Api.GitHub.Enum.SecurityVulnerabilityOrderField
import Api.GitHub.Enum.SponsorsTierOrderField
import Api.GitHub.Enum.SponsorshipOrderField
import Api.GitHub.Enum.StarOrderField
import Api.GitHub.Enum.SubscriptionState
import Api.GitHub.Enum.TeamDiscussionCommentOrderField
import Api.GitHub.Enum.TeamDiscussionOrderField
import Api.GitHub.Enum.TeamMemberOrderField
import Api.GitHub.Enum.TeamOrderField
import Api.GitHub.Enum.TeamRepositoryOrderField
import Api.GitHub.Enum.TopicSuggestionDeclineReason
import Api.GitHub.Enum.UserStatusOrderField
...
type alias AcceptEnterpriseAdministratorInvitationInputRequiredFields =
    { invitationId : Api.GitHub.ScalarCodecs.Id }
...
encodeAcceptEnterpriseAdministratorInvitationInput input =
    Encode.maybeObject
        [ ( "invitationId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.invitationId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AcceptTopicSuggestionInputRequiredFields =
    { repositoryId : Api.GitHub.ScalarCodecs.Id
    , name : String
    }
...
encodeAcceptTopicSuggestionInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "name", Encode.string input.name |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddAssigneesToAssignableInputRequiredFields =
    { assignableId : Api.GitHub.ScalarCodecs.Id
    , assigneeIds : List Api.GitHub.ScalarCodecs.Id
    }
...
encodeAddAssigneesToAssignableInput input =
    Encode.maybeObject
        [ ( "assignableId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.assignableId |> Just ), ( "assigneeIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) input.assigneeIds |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddCommentInputRequiredFields =
    { subjectId : Api.GitHub.ScalarCodecs.Id
    , body : String
    }
...
encodeAddCommentInput input =
    Encode.maybeObject
        [ ( "subjectId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.subjectId |> Just ), ( "body", Encode.string input.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddLabelsToLabelableInputRequiredFields =
    { labelableId : Api.GitHub.ScalarCodecs.Id
    , labelIds : List Api.GitHub.ScalarCodecs.Id
    }
...
encodeAddLabelsToLabelableInput input =
    Encode.maybeObject
        [ ( "labelableId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.labelableId |> Just ), ( "labelIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) input.labelIds |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddProjectCardInputRequiredFields =
    { projectColumnId : Api.GitHub.ScalarCodecs.Id }


type alias AddProjectCardInputOptionalFields =
    { contentId : OptionalArgument Api.GitHub.ScalarCodecs.Id
...
encodeAddProjectCardInput input =
    Encode.maybeObject
        [ ( "projectColumnId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.projectColumnId |> Just ), ( "contentId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.contentId ), ( "note", Encode.string |> Encode.optional input.note ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddProjectColumnInputRequiredFields =
    { projectId : Api.GitHub.ScalarCodecs.Id
    , name : String
    }
...
encodeAddProjectColumnInput input =
    Encode.maybeObject
        [ ( "projectId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.projectId |> Just ), ( "name", Encode.string input.name |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddPullRequestReviewCommentInputRequiredFields =
    { pullRequestReviewId : Api.GitHub.ScalarCodecs.Id
    , body : String
    }


type alias AddPullRequestReviewCommentInputOptionalFields =
    { commitOID : OptionalArgument Api.GitHub.ScalarCodecs.GitObjectID
    , path : OptionalArgument String
    , position : OptionalArgument Int
    , inReplyTo : OptionalArgument Api.GitHub.ScalarCodecs.Id
    , clientMutationId : OptionalArgument String
    }
...
encodeAddPullRequestReviewCommentInput input =
    Encode.maybeObject
        [ ( "pullRequestReviewId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestReviewId |> Just ), ( "commitOID", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input.commitOID ), ( "body", Encode.string input.body |> Just ), ( "path", Encode.string |> Encode.optional input.path ), ( "position", Encode.int |> Encode.optional input.position ), ( "inReplyTo", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.inReplyTo ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddPullRequestReviewInputRequiredFields =
    { pullRequestId : Api.GitHub.ScalarCodecs.Id }


type alias AddPullRequestReviewInputOptionalFields =
    { commitOID : OptionalArgument Api.GitHub.ScalarCodecs.GitObjectID
    , body : OptionalArgument String
    , event : OptionalArgument Api.GitHub.Enum.PullRequestReviewEvent.PullRequestReviewEvent
...
encodeAddPullRequestReviewInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "commitOID", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input.commitOID ), ( "body", Encode.string |> Encode.optional input.body ), ( "event", Encode.enum Api.GitHub.Enum.PullRequestReviewEvent.toString |> Encode.optional input.event ), ( "comments", (encodeDraftPullRequestReviewComment |> Encode.maybe |> Encode.list) |> Encode.optional input.comments ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddReactionInputRequiredFields =
    { subjectId : Api.GitHub.ScalarCodecs.Id
    , content : Api.GitHub.Enum.ReactionContent.ReactionContent
    }
...
encodeAddReactionInput input =
    Encode.maybeObject
        [ ( "subjectId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.subjectId |> Just ), ( "content", Encode.enum Api.GitHub.Enum.ReactionContent.toString input.content |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AddStarInputRequiredFields =
    { starrableId : Api.GitHub.ScalarCodecs.Id }
...
encodeAddStarInput input =
    Encode.maybeObject
        [ ( "starrableId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.starrableId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeArchiveRepositoryInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias AuditLogOrderOptionalFields =
    { field : OptionalArgument Api.GitHub.Enum.AuditLogOrderField.AuditLogOrderField
...
encodeAuditLogOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.AuditLogOrderField.toString |> Encode.optional input.field ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString |> Encode.optional input.direction ) ]
...
type alias ChangeUserStatusInputOptionalFields =
    ...
    , expiresAt : OptionalArgument Api.GitHub.ScalarCodecs.DateTime
    , clientMutationId : OptionalArgument String
    }
...
encodeChangeUserStatusInput input =
    Encode.maybeObject
        [ ( "emoji", Encode.string |> Encode.optional input.emoji ), ( "message", Encode.string |> Encode.optional input.message ), ( "organizationId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.organizationId ), ( "limitedAvailability", Encode.bool |> Encode.optional input.limitedAvailability ), ( "expiresAt", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.expiresAt ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeClearLabelsFromLabelableInput input =
    Encode.maybeObject
        [ ( "labelableId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.labelableId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CloneProjectInputRequiredFields =
    { targetOwnerId : Api.GitHub.ScalarCodecs.Id
    , sourceId : Api.GitHub.ScalarCodecs.Id
...
encodeCloneProjectInput input =
    Encode.maybeObject
        [ ( "targetOwnerId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.targetOwnerId |> Just ), ( "sourceId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.sourceId |> Just ), ( "includeWorkflows", Encode.bool input.includeWorkflows |> Just ), ( "name", Encode.string input.name |> Just ), ( "body", Encode.string |> Encode.optional input.body ), ( "public", Encode.bool |> Encode.optional input.public ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CloneTemplateRepositoryInputRequiredFields =
    { repositoryId : Api.GitHub.ScalarCodecs.Id
    , name : String
    , ownerId : Api.GitHub.ScalarCodecs.Id
    , visibility : Api.GitHub.Enum.RepositoryVisibility.RepositoryVisibility
    }
...
encodeCloneTemplateRepositoryInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "name", Encode.string input.name |> Just ), ( "ownerId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.ownerId |> Just ), ( "description", Encode.string |> Encode.optional input.description ), ( "visibility", Encode.enum Api.GitHub.Enum.RepositoryVisibility.toString input.visibility |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CloseIssueInputRequiredFields =
    { issueId : Api.GitHub.ScalarCodecs.Id }
...
encodeCloseIssueInput input =
    Encode.maybeObject
        [ ( "issueId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.issueId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeClosePullRequestInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CommitAuthorOptionalFields =
    { id : OptionalArgument Api.GitHub.ScalarCodecs.Id
...
encodeCommitAuthor input =
    Encode.maybeObject
        [ ( "id", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id ), ( "emails", (Encode.string |> Encode.list) |> Encode.optional input.emails ) ]
...
type alias CommitContributionOrderRequiredFields =
    { field : Api.GitHub.Enum.CommitContributionOrderField.CommitContributionOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeCommitContributionOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.CommitContributionOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias ContributionOrderOptionalFields =
    { field : OptionalArgument Api.GitHub.Enum.ContributionOrderField.ContributionOrderField }
...
encodeContributionOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.ContributionOrderField.toString |> Encode.optional input.field ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias ConvertProjectCardNoteToIssueInputRequiredFields =
    { projectCardId : Api.GitHub.ScalarCodecs.Id
    , repositoryId : Api.GitHub.ScalarCodecs.Id
    }
...
encodeConvertProjectCardNoteToIssueInput input =
    Encode.maybeObject
        [ ( "projectCardId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.projectCardId |> Just ), ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "title", Encode.string |> Encode.optional input.title ), ( "body", Encode.string |> Encode.optional input.body ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateBranchProtectionRuleInputOptionalFields =
    ...
    , reviewDismissalActorIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , restrictsPushes : OptionalArgument Bool
    , pushActorIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
...
encodeCreateBranchProtectionRuleInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "pattern", Encode.string input.pattern |> Just ), ( "requiresApprovingReviews", Encode.bool |> Encode.optional input.requiresApprovingReviews ), ( "requiredApprovingReviewCount", Encode.int |> Encode.optional input.requiredApprovingReviewCount ), ( "requiresCommitSignatures", Encode.bool |> Encode.optional input.requiresCommitSignatures ), ( "isAdminEnforced", Encode.bool |> Encode.optional input.isAdminEnforced ), ( "requiresStatusChecks", Encode.bool |> Encode.optional input.requiresStatusChecks ), ( "requiresStrictStatusChecks", Encode.bool |> Encode.optional input.requiresStrictStatusChecks ), ( "requiresCodeOwnerReviews", Encode.bool |> Encode.optional input.requiresCodeOwnerReviews ), ( "dismissesStaleReviews", Encode.bool |> Encode.optional input.dismissesStaleReviews ), ( "restrictsReviewDismissals", Encode.bool |> Encode.optional input.restrictsReviewDismissals ), ( "reviewDismissalActorIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.reviewDismissalActorIds ), ( "restrictsPushes", Encode.bool |> Encode.optional input.restrictsPushes ), ( "pushActorIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.pushActorIds ), ( "requiredStatusCheckContexts", (Encode.string |> Encode.list) |> Encode.optional input.requiredStatusCheckContexts ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateContentAttachmentInputRequiredFields =
    { contentReferenceId : Api.GitHub.ScalarCodecs.Id
    , title : String
    , body : String
    }
...
encodeCreateContentAttachmentInput input =
    Encode.maybeObject
        [ ( "contentReferenceId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.contentReferenceId |> Just ), ( "title", Encode.string input.title |> Just ), ( "body", Encode.string input.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateEnterpriseOrganizationInputRequiredFields =
    { enterpriseId : Api.GitHub.ScalarCodecs.Id
    , login : String
    , profileName : String
    , billingEmail : String
...
encodeCreateEnterpriseOrganizationInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "login", Encode.string input.login |> Just ), ( "profileName", Encode.string input.profileName |> Just ), ( "billingEmail", Encode.string input.billingEmail |> Just ), ( "adminLogins", (Encode.string |> Encode.list) input.adminLogins |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateIssueInputOptionalFields =
    { body : OptionalArgument String
    , assigneeIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , milestoneId : OptionalArgument Api.GitHub.ScalarCodecs.Id
    , labelIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , projectIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , clientMutationId : OptionalArgument String
    }
...
encodeCreateIssueInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "title", Encode.string input.title |> Just ), ( "body", Encode.string |> Encode.optional input.body ), ( "assigneeIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.assigneeIds ), ( "milestoneId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.milestoneId ), ( "labelIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.labelIds ), ( "projectIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.projectIds ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateProjectInputOptionalFields =
    { body : OptionalArgument String
    , template : OptionalArgument Api.GitHub.Enum.ProjectTemplate.ProjectTemplate
    , repositoryIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , clientMutationId : OptionalArgument String
    }
...
encodeCreateProjectInput input =
    Encode.maybeObject
        [ ( "ownerId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.ownerId |> Just ), ( "name", Encode.string input.name |> Just ), ( "body", Encode.string |> Encode.optional input.body ), ( "template", Encode.enum Api.GitHub.Enum.ProjectTemplate.toString |> Encode.optional input.template ), ( "repositoryIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.repositoryIds ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeCreatePullRequestInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "baseRefName", Encode.string input.baseRefName |> Just ), ( "headRefName", Encode.string input.headRefName |> Just ), ( "title", Encode.string input.title |> Just ), ( "body", Encode.string |> Encode.optional input.body ), ( "maintainerCanModify", Encode.bool |> Encode.optional input.maintainerCanModify ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateRefInputRequiredFields =
    { repositoryId : Api.GitHub.ScalarCodecs.Id
    , name : String
    , oid : Api.GitHub.ScalarCodecs.GitObjectID
    }
...
encodeCreateRefInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "name", Encode.string input.name |> Just ), ( "oid", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecGitObjectID) input.oid |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateRepositoryInputOptionalFields =
    { ownerId : OptionalArgument Api.GitHub.ScalarCodecs.Id
    , description : OptionalArgument String
    , template : OptionalArgument Bool
    , homepageUrl : OptionalArgument Api.GitHub.ScalarCodecs.Uri
    , hasWikiEnabled : OptionalArgument Bool
    , hasIssuesEnabled : OptionalArgument Bool
    , teamId : OptionalArgument Api.GitHub.ScalarCodecs.Id
    , clientMutationId : OptionalArgument String
    }
...
encodeCreateRepositoryInput input =
    Encode.maybeObject
        [ ( "name", Encode.string input.name |> Just ), ( "ownerId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.ownerId ), ( "description", Encode.string |> Encode.optional input.description ), ( "visibility", Encode.enum Api.GitHub.Enum.RepositoryVisibility.toString input.visibility |> Just ), ( "template", Encode.bool |> Encode.optional input.template ), ( "homepageUrl", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecUri) |> Encode.optional input.homepageUrl ), ( "hasWikiEnabled", Encode.bool |> Encode.optional input.hasWikiEnabled ), ( "hasIssuesEnabled", Encode.bool |> Encode.optional input.hasIssuesEnabled ), ( "teamId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.teamId ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateTeamDiscussionCommentInputRequiredFields =
    { discussionId : Api.GitHub.ScalarCodecs.Id
    , body : String
    }
...
encodeCreateTeamDiscussionCommentInput input =
    Encode.maybeObject
        [ ( "discussionId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.discussionId |> Just ), ( "body", Encode.string input.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias CreateTeamDiscussionInputRequiredFields =
    { teamId : Api.GitHub.ScalarCodecs.Id
    , title : String
    , body : String
    }
...
encodeCreateTeamDiscussionInput input =
    Encode.maybeObject
        [ ( "teamId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.teamId |> Just ), ( "title", Encode.string input.title |> Just ), ( "body", Encode.string input.body |> Just ), ( "private", Encode.bool |> Encode.optional input.private ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias DeclineTopicSuggestionInputRequiredFields =
    { repositoryId : Api.GitHub.ScalarCodecs.Id
    , name : String
    , reason : Api.GitHub.Enum.TopicSuggestionDeclineReason.TopicSuggestionDeclineReason
    }
...
encodeDeclineTopicSuggestionInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "name", Encode.string input.name |> Just ), ( "reason", Encode.enum Api.GitHub.Enum.TopicSuggestionDeclineReason.toString input.reason |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias DeleteBranchProtectionRuleInputRequiredFields =
    { branchProtectionRuleId : Api.GitHub.ScalarCodecs.Id }
...
encodeDeleteBranchProtectionRuleInput input =
    Encode.maybeObject
        [ ( "branchProtectionRuleId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.branchProtectionRuleId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeDeleteIssueCommentInput input =
    Encode.maybeObject
        [ ( "id", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.id |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias DeletePackageVersionInputRequiredFields =
    { packageVersionId : Api.GitHub.ScalarCodecs.Id }
...
encodeDeletePackageVersionInput input =
    Encode.maybeObject
        [ ( "packageVersionId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.packageVersionId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias DeleteProjectCardInputRequiredFields =
    { cardId : Api.GitHub.ScalarCodecs.Id }
...
encodeDeleteProjectCardInput input =
    Encode.maybeObject
        [ ( "cardId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.cardId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias DeleteProjectColumnInputRequiredFields =
    { columnId : Api.GitHub.ScalarCodecs.Id }
...
encodeDeleteProjectColumnInput input =
    Encode.maybeObject
        [ ( "columnId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.columnId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeDeleteProjectInput input =
    Encode.maybeObject
        [ ( "projectId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.projectId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeDeletePullRequestReviewInput input =
    Encode.maybeObject
        [ ( "pullRequestReviewId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestReviewId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias DeleteRefInputRequiredFields =
    { refId : Api.GitHub.ScalarCodecs.Id }
...
encodeDeleteRefInput input =
    Encode.maybeObject
        [ ( "refId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.refId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias DeploymentOrderRequiredFields =
    { field : Api.GitHub.Enum.DeploymentOrderField.DeploymentOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeDeploymentOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.DeploymentOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
encodeDismissPullRequestReviewInput input =
    Encode.maybeObject
        [ ( "pullRequestReviewId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestReviewId |> Just ), ( "message", Encode.string input.message |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias EnterpriseAdministratorInvitationOrderRequiredFields =
    { field : Api.GitHub.Enum.EnterpriseAdministratorInvitationOrderField.EnterpriseAdministratorInvitationOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeEnterpriseAdministratorInvitationOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.EnterpriseAdministratorInvitationOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias EnterpriseMemberOrderRequiredFields =
    { field : Api.GitHub.Enum.EnterpriseMemberOrderField.EnterpriseMemberOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeEnterpriseMemberOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.EnterpriseMemberOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias EnterpriseOrderRequiredFields =
    { field : Api.GitHub.Enum.EnterpriseOrderField.EnterpriseOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeEnterpriseOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.EnterpriseOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias EnterpriseServerInstallationOrderRequiredFields =
    { field : Api.GitHub.Enum.EnterpriseServerInstallationOrderField.EnterpriseServerInstallationOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeEnterpriseServerInstallationOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.EnterpriseServerInstallationOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias EnterpriseServerUserAccountEmailOrderRequiredFields =
    { field : Api.GitHub.Enum.EnterpriseServerUserAccountEmailOrderField.EnterpriseServerUserAccountEmailOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeEnterpriseServerUserAccountEmailOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.EnterpriseServerUserAccountEmailOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias EnterpriseServerUserAccountOrderRequiredFields =
    { field : Api.GitHub.Enum.EnterpriseServerUserAccountOrderField.EnterpriseServerUserAccountOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeEnterpriseServerUserAccountOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.EnterpriseServerUserAccountOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias EnterpriseServerUserAccountsUploadOrderRequiredFields =
    { field : Api.GitHub.Enum.EnterpriseServerUserAccountsUploadOrderField.EnterpriseServerUserAccountsUploadOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeEnterpriseServerUserAccountsUploadOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.EnterpriseServerUserAccountsUploadOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias FollowUserInputRequiredFields =
    { userId : Api.GitHub.ScalarCodecs.Id }
...
encodeFollowUserInput input =
    Encode.maybeObject
        [ ( "userId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.userId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias GistOrderRequiredFields =
    { field : Api.GitHub.Enum.GistOrderField.GistOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeGistOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.GistOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias InviteEnterpriseAdminInputOptionalFields =
    ...
    , role : OptionalArgument Api.GitHub.Enum.EnterpriseAdministratorRole.EnterpriseAdministratorRole
    , clientMutationId : OptionalArgument String
    }
...
encodeInviteEnterpriseAdminInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "invitee", Encode.string |> Encode.optional input.invitee ), ( "email", Encode.string |> Encode.optional input.email ), ( "role", Encode.enum Api.GitHub.Enum.EnterpriseAdministratorRole.toString |> Encode.optional input.role ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeIssueFilters input =
    Encode.maybeObject
        [ ( "assignee", Encode.string |> Encode.optional input.assignee ), ( "createdBy", Encode.string |> Encode.optional input.createdBy ), ( "labels", (Encode.string |> Encode.list) |> Encode.optional input.labels ), ( "mentioned", Encode.string |> Encode.optional input.mentioned ), ( "milestone", Encode.string |> Encode.optional input.milestone ), ( "since", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.since ), ( "states", (Encode.enum Api.GitHub.Enum.IssueState.toString |> Encode.list) |> Encode.optional input.states ), ( "viewerSubscribed", Encode.bool |> Encode.optional input.viewerSubscribed ) ]
...
type alias IssueOrderRequiredFields =
    { field : Api.GitHub.Enum.IssueOrderField.IssueOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeIssueOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.IssueOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias LabelOrderRequiredFields =
    { field : Api.GitHub.Enum.LabelOrderField.LabelOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeLabelOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.LabelOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias LanguageOrderRequiredFields =
    { field : Api.GitHub.Enum.LanguageOrderField.LanguageOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeLanguageOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.LanguageOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
encodeLinkRepositoryToProjectInput input =
    Encode.maybeObject
        [ ( "projectId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.projectId |> Just ), ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias LockLockableInputRequiredFields =
    { lockableId : Api.GitHub.ScalarCodecs.Id }


type alias LockLockableInputOptionalFields =
    { lockReason : OptionalArgument Api.GitHub.Enum.LockReason.LockReason
    , clientMutationId : OptionalArgument String
    }
...
encodeLockLockableInput input =
    Encode.maybeObject
        [ ( "lockableId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.lockableId |> Just ), ( "lockReason", Encode.enum Api.GitHub.Enum.LockReason.toString |> Encode.optional input.lockReason ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias MergePullRequestInputOptionalFields =
    ...
    , expectedHeadOid : OptionalArgument Api.GitHub.ScalarCodecs.GitObjectID
    , mergeMethod : OptionalArgument Api.GitHub.Enum.PullRequestMergeMethod.PullRequestMergeMethod
    , clientMutationId : OptionalArgument String
    }
...
encodeMergePullRequestInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "commitHeadline", Encode.string |> Encode.optional input.commitHeadline ), ( "commitBody", Encode.string |> Encode.optional input.commitBody ), ( "expectedHeadOid", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecGitObjectID) |> Encode.optional input.expectedHeadOid ), ( "mergeMethod", Encode.enum Api.GitHub.Enum.PullRequestMergeMethod.toString |> Encode.optional input.mergeMethod ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias MilestoneOrderRequiredFields =
    { field : Api.GitHub.Enum.MilestoneOrderField.MilestoneOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeMilestoneOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.MilestoneOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias MinimizeCommentInputRequiredFields =
    { subjectId : Api.GitHub.ScalarCodecs.Id
    , classifier : Api.GitHub.Enum.ReportedContentClassifiers.ReportedContentClassifiers
    }
...
encodeMinimizeCommentInput input =
    Encode.maybeObject
        [ ( "subjectId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.subjectId |> Just ), ( "classifier", Encode.enum Api.GitHub.Enum.ReportedContentClassifiers.toString input.classifier |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias MoveProjectCardInputOptionalFields =
    { afterCardId : OptionalArgument Api.GitHub.ScalarCodecs.Id
    , clientMutationId : OptionalArgument String
    }
...
encodeMoveProjectCardInput input =
    Encode.maybeObject
        [ ( "cardId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.cardId |> Just ), ( "columnId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.columnId |> Just ), ( "afterCardId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.afterCardId ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias MoveProjectColumnInputOptionalFields =
    { afterColumnId : OptionalArgument Api.GitHub.ScalarCodecs.Id
    , clientMutationId : OptionalArgument String
    }
...
encodeMoveProjectColumnInput input =
    Encode.maybeObject
        [ ( "columnId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.columnId |> Just ), ( "afterColumnId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.afterColumnId ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias OrganizationOrderRequiredFields =
    { field : Api.GitHub.Enum.OrganizationOrderField.OrganizationOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeOrganizationOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.OrganizationOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias ProjectOrderRequiredFields =
    { field : Api.GitHub.Enum.ProjectOrderField.ProjectOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeProjectOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.ProjectOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias PullRequestOrderRequiredFields =
    { field : Api.GitHub.Enum.PullRequestOrderField.PullRequestOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodePullRequestOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.PullRequestOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias ReactionOrderRequiredFields =
    { field : Api.GitHub.Enum.ReactionOrderField.ReactionOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeReactionOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.ReactionOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias RefOrderRequiredFields =
    { field : Api.GitHub.Enum.RefOrderField.RefOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeRefOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.RefOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
encodeRegenerateEnterpriseIdentityProviderRecoveryCodesInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias ReleaseOrderRequiredFields =
    { field : Api.GitHub.Enum.ReleaseOrderField.ReleaseOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeReleaseOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.ReleaseOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
encodeRemoveEnterpriseAdminInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "login", Encode.string input.login |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias RemoveEnterpriseOrganizationInputRequiredFields =
    { enterpriseId : Api.GitHub.ScalarCodecs.Id
    , organizationId : Api.GitHub.ScalarCodecs.Id
    }
...
encodeRemoveEnterpriseOrganizationInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "organizationId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.organizationId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeRemoveOutsideCollaboratorInput input =
    Encode.maybeObject
        [ ( "userId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.userId |> Just ), ( "organizationId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.organizationId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias RepositoryInvitationOrderRequiredFields =
    { field : Api.GitHub.Enum.RepositoryInvitationOrderField.RepositoryInvitationOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeRepositoryInvitationOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.RepositoryInvitationOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias RepositoryOrderRequiredFields =
    { field : Api.GitHub.Enum.RepositoryOrderField.RepositoryOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeRepositoryOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.RepositoryOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias RequestReviewsInputOptionalFields =
    { userIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , teamIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
...
encodeRequestReviewsInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "userIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.userIds ), ( "teamIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.teamIds ), ( "union", Encode.bool |> Encode.optional input.union ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias ResolveReviewThreadInputRequiredFields =
    { threadId : Api.GitHub.ScalarCodecs.Id }
...
encodeResolveReviewThreadInput input =
    Encode.maybeObject
        [ ( "threadId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.threadId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias SavedReplyOrderRequiredFields =
    { field : Api.GitHub.Enum.SavedReplyOrderField.SavedReplyOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeSavedReplyOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.SavedReplyOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias SecurityAdvisoryIdentifierFilterRequiredFields =
    { type_ : Api.GitHub.Enum.SecurityAdvisoryIdentifierType.SecurityAdvisoryIdentifierType
    , value : String
    }
...
encodeSecurityAdvisoryIdentifierFilter input =
    Encode.maybeObject
        [ ( "type", Encode.enum Api.GitHub.Enum.SecurityAdvisoryIdentifierType.toString input.type_ |> Just ), ( "value", Encode.string input.value |> Just ) ]
...
type alias SecurityAdvisoryOrderRequiredFields =
    { field : Api.GitHub.Enum.SecurityAdvisoryOrderField.SecurityAdvisoryOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeSecurityAdvisoryOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.SecurityAdvisoryOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias SecurityVulnerabilityOrderRequiredFields =
    { field : Api.GitHub.Enum.SecurityVulnerabilityOrderField.SecurityVulnerabilityOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeSecurityVulnerabilityOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.SecurityVulnerabilityOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias SponsorsTierOrderRequiredFields =
    { field : Api.GitHub.Enum.SponsorsTierOrderField.SponsorsTierOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeSponsorsTierOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.SponsorsTierOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias SponsorshipOrderRequiredFields =
    { field : Api.GitHub.Enum.SponsorshipOrderField.SponsorshipOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeSponsorshipOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.SponsorshipOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias StarOrderRequiredFields =
    { field : Api.GitHub.Enum.StarOrderField.StarOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeStarOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.StarOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias SubmitPullRequestReviewInputRequiredFields =
    { pullRequestReviewId : Api.GitHub.ScalarCodecs.Id
    , event : Api.GitHub.Enum.PullRequestReviewEvent.PullRequestReviewEvent
    }
...
encodeSubmitPullRequestReviewInput input =
    Encode.maybeObject
        [ ( "pullRequestReviewId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestReviewId |> Just ), ( "event", Encode.enum Api.GitHub.Enum.PullRequestReviewEvent.toString input.event |> Just ), ( "body", Encode.string |> Encode.optional input.body ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias TeamDiscussionCommentOrderRequiredFields =
    { field : Api.GitHub.Enum.TeamDiscussionCommentOrderField.TeamDiscussionCommentOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeTeamDiscussionCommentOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.TeamDiscussionCommentOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias TeamDiscussionOrderRequiredFields =
    { field : Api.GitHub.Enum.TeamDiscussionOrderField.TeamDiscussionOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeTeamDiscussionOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.TeamDiscussionOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias TeamMemberOrderRequiredFields =
    { field : Api.GitHub.Enum.TeamMemberOrderField.TeamMemberOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeTeamMemberOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.TeamMemberOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias TeamOrderRequiredFields =
    { field : Api.GitHub.Enum.TeamOrderField.TeamOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeTeamOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.TeamOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
type alias TeamRepositoryOrderRequiredFields =
    { field : Api.GitHub.Enum.TeamRepositoryOrderField.TeamRepositoryOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeTeamRepositoryOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.TeamRepositoryOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
...
encodeTransferIssueInput input =
    Encode.maybeObject
        [ ( "issueId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.issueId |> Just ), ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUnlockLockableInput input =
    Encode.maybeObject
        [ ( "lockableId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.lockableId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UnmarkIssueAsDuplicateInputRequiredFields =
    { duplicateId : Api.GitHub.ScalarCodecs.Id
    , canonicalId : Api.GitHub.ScalarCodecs.Id
    }
...
encodeUnmarkIssueAsDuplicateInput input =
    Encode.maybeObject
        [ ( "duplicateId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.duplicateId |> Just ), ( "canonicalId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.canonicalId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUnminimizeCommentInput input =
    Encode.maybeObject
        [ ( "subjectId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.subjectId |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateBranchProtectionRuleInput input =
    Encode.maybeObject
        [ ( "branchProtectionRuleId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.branchProtectionRuleId |> Just ), ( "pattern", Encode.string |> Encode.optional input.pattern ), ( "requiresApprovingReviews", Encode.bool |> Encode.optional input.requiresApprovingReviews ), ( "requiredApprovingReviewCount", Encode.int |> Encode.optional input.requiredApprovingReviewCount ), ( "requiresCommitSignatures", Encode.bool |> Encode.optional input.requiresCommitSignatures ), ( "isAdminEnforced", Encode.bool |> Encode.optional input.isAdminEnforced ), ( "requiresStatusChecks", Encode.bool |> Encode.optional input.requiresStatusChecks ), ( "requiresStrictStatusChecks", Encode.bool |> Encode.optional input.requiresStrictStatusChecks ), ( "requiresCodeOwnerReviews", Encode.bool |> Encode.optional input.requiresCodeOwnerReviews ), ( "dismissesStaleReviews", Encode.bool |> Encode.optional input.dismissesStaleReviews ), ( "restrictsReviewDismissals", Encode.bool |> Encode.optional input.restrictsReviewDismissals ), ( "reviewDismissalActorIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.reviewDismissalActorIds ), ( "restrictsPushes", Encode.bool |> Encode.optional input.restrictsPushes ), ( "pushActorIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.pushActorIds ), ( "requiredStatusCheckContexts", (Encode.string |> Encode.list) |> Encode.optional input.requiredStatusCheckContexts ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdateEnterpriseActionExecutionCapabilitySettingInputRequiredFields =
    { enterpriseId : Api.GitHub.ScalarCodecs.Id
    , capability : Api.GitHub.Enum.ActionExecutionCapabilitySetting.ActionExecutionCapabilitySetting
    }
...
encodeUpdateEnterpriseActionExecutionCapabilitySettingInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "capability", Encode.enum Api.GitHub.Enum.ActionExecutionCapabilitySetting.toString input.capability |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateEnterpriseAdministratorRoleInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "login", Encode.string input.login |> Just ), ( "role", Encode.enum Api.GitHub.Enum.EnterpriseAdministratorRole.toString input.role |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdateEnterpriseAllowPrivateRepositoryForkingSettingInputRequiredFields =
    { enterpriseId : Api.GitHub.ScalarCodecs.Id
    , settingValue : Api.GitHub.Enum.EnterpriseEnabledDisabledSettingValue.EnterpriseEnabledDisabledSettingValue
    }
...
encodeUpdateEnterpriseAllowPrivateRepositoryForkingSettingInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.GitHub.Enum.EnterpriseEnabledDisabledSettingValue.toString input.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdateEnterpriseDefaultRepositoryPermissionSettingInputRequiredFields =
    { enterpriseId : Api.GitHub.ScalarCodecs.Id
    , settingValue : Api.GitHub.Enum.EnterpriseDefaultRepositoryPermissionSettingValue.EnterpriseDefaultRepositoryPermissionSettingValue
    }
...
encodeUpdateEnterpriseDefaultRepositoryPermissionSettingInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.GitHub.Enum.EnterpriseDefaultRepositoryPermissionSettingValue.toString input.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdateEnterpriseMembersCanCreateRepositoriesSettingInputOptionalFields =
    { settingValue : OptionalArgument Api.GitHub.Enum.EnterpriseMembersCanCreateRepositoriesSettingValue.EnterpriseMembersCanCreateRepositoriesSettingValue
...
type alias UpdateEnterpriseMembersCanMakePurchasesSettingInputRequiredFields =
    { enterpriseId : Api.GitHub.ScalarCodecs.Id
    , settingValue : Api.GitHub.Enum.EnterpriseMembersCanMakePurchasesSettingValue.EnterpriseMembersCanMakePurchasesSettingValue
    }
...
encodeUpdateEnterpriseMembersCanMakePurchasesSettingInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.GitHub.Enum.EnterpriseMembersCanMakePurchasesSettingValue.toString input.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateEnterpriseProfileInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "name", Encode.string |> Encode.optional input.name ), ( "description", Encode.string |> Encode.optional input.description ), ( "websiteUrl", Encode.string |> Encode.optional input.websiteUrl ), ( "location", Encode.string |> Encode.optional input.location ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdateEnterpriseTwoFactorAuthenticationRequiredSettingInputRequiredFields =
    { enterpriseId : Api.GitHub.ScalarCodecs.Id
    , settingValue : Api.GitHub.Enum.EnterpriseEnabledSettingValue.EnterpriseEnabledSettingValue
    }
...
encodeUpdateEnterpriseTwoFactorAuthenticationRequiredSettingInput input =
    Encode.maybeObject
        [ ( "enterpriseId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.enterpriseId |> Just ), ( "settingValue", Encode.enum Api.GitHub.Enum.EnterpriseEnabledSettingValue.toString input.settingValue |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateIssueCommentInput input =
    Encode.maybeObject
        [ ( "id", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.id |> Just ), ( "body", Encode.string input.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdateIssueInputOptionalFields =
    ...
    , milestoneId : OptionalArgument Api.GitHub.ScalarCodecs.Id
    , labelIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , state : OptionalArgument Api.GitHub.Enum.IssueState.IssueState
    , projectIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , clientMutationId : OptionalArgument String
    }
...
encodeUpdateIssueInput input =
    Encode.maybeObject
        [ ( "id", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.id |> Just ), ( "title", Encode.string |> Encode.optional input.title ), ( "body", Encode.string |> Encode.optional input.body ), ( "assigneeIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.assigneeIds ), ( "milestoneId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.milestoneId ), ( "labelIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.labelIds ), ( "state", Encode.enum Api.GitHub.Enum.IssueState.toString |> Encode.optional input.state ), ( "projectIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.projectIds ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateProjectCardInput input =
    Encode.maybeObject
        [ ( "projectCardId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.projectCardId |> Just ), ( "isArchived", Encode.bool |> Encode.optional input.isArchived ), ( "note", Encode.string |> Encode.optional input.note ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateProjectColumnInput input =
    Encode.maybeObject
        [ ( "projectColumnId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.projectColumnId |> Just ), ( "name", Encode.string input.name |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdateProjectInputOptionalFields =
    { name : OptionalArgument String
    , body : OptionalArgument String
    , state : OptionalArgument Api.GitHub.Enum.ProjectState.ProjectState
    , public : OptionalArgument Bool
    , clientMutationId : OptionalArgument String
    }
...
encodeUpdateProjectInput input =
    Encode.maybeObject
        [ ( "projectId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.projectId |> Just ), ( "name", Encode.string |> Encode.optional input.name ), ( "body", Encode.string |> Encode.optional input.body ), ( "state", Encode.enum Api.GitHub.Enum.ProjectState.toString |> Encode.optional input.state ), ( "public", Encode.bool |> Encode.optional input.public ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdatePullRequestInputOptionalFields =
    ...
    , title : OptionalArgument String
    , body : OptionalArgument String
    , state : OptionalArgument Api.GitHub.Enum.PullRequestUpdateState.PullRequestUpdateState
    , maintainerCanModify : OptionalArgument Bool
    , assigneeIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
    , milestoneId : OptionalArgument Api.GitHub.ScalarCodecs.Id
    , labelIds : OptionalArgument (List Api.GitHub.ScalarCodecs.Id)
...
encodeUpdatePullRequestInput input =
    Encode.maybeObject
        [ ( "pullRequestId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestId |> Just ), ( "baseRefName", Encode.string |> Encode.optional input.baseRefName ), ( "title", Encode.string |> Encode.optional input.title ), ( "body", Encode.string |> Encode.optional input.body ), ( "state", Encode.enum Api.GitHub.Enum.PullRequestUpdateState.toString |> Encode.optional input.state ), ( "maintainerCanModify", Encode.bool |> Encode.optional input.maintainerCanModify ), ( "assigneeIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.assigneeIds ), ( "milestoneId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.optional input.milestoneId ), ( "labelIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.labelIds ), ( "projectIds", ((Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.projectIds ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdatePullRequestReviewCommentInputRequiredFields =
    { pullRequestReviewCommentId : Api.GitHub.ScalarCodecs.Id
    , body : String
    }
...
encodeUpdatePullRequestReviewCommentInput input =
    Encode.maybeObject
        [ ( "pullRequestReviewCommentId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestReviewCommentId |> Just ), ( "body", Encode.string input.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdatePullRequestReviewInput input =
    Encode.maybeObject
        [ ( "pullRequestReviewId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.pullRequestReviewId |> Just ), ( "body", Encode.string input.body |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateRefInput input =
    Encode.maybeObject
        [ ( "refId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.refId |> Just ), ( "oid", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecGitObjectID) input.oid |> Just ), ( "force", Encode.bool |> Encode.optional input.force ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateRepositoryInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "name", Encode.string |> Encode.optional input.name ), ( "description", Encode.string |> Encode.optional input.description ), ( "template", Encode.bool |> Encode.optional input.template ), ( "homepageUrl", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecUri) |> Encode.optional input.homepageUrl ), ( "hasWikiEnabled", Encode.bool |> Encode.optional input.hasWikiEnabled ), ( "hasIssuesEnabled", Encode.bool |> Encode.optional input.hasIssuesEnabled ), ( "hasProjectsEnabled", Encode.bool |> Encode.optional input.hasProjectsEnabled ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UpdateSubscriptionInputRequiredFields =
    { subscribableId : Api.GitHub.ScalarCodecs.Id
    , state : Api.GitHub.Enum.SubscriptionState.SubscriptionState
    }
...
encodeUpdateSubscriptionInput input =
    Encode.maybeObject
        [ ( "subscribableId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.subscribableId |> Just ), ( "state", Encode.enum Api.GitHub.Enum.SubscriptionState.toString input.state |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateTeamDiscussionCommentInput input =
    Encode.maybeObject
        [ ( "id", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.id |> Just ), ( "body", Encode.string input.body |> Just ), ( "bodyVersion", Encode.string |> Encode.optional input.bodyVersion ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
encodeUpdateTopicsInput input =
    Encode.maybeObject
        [ ( "repositoryId", (Api.GitHub.ScalarCodecs.codecs |> Api.GitHub.Scalar.unwrapEncoder .codecId) input.repositoryId |> Just ), ( "topicNames", (Encode.string |> Encode.list) input.topicNames |> Just ), ( "clientMutationId", Encode.string |> Encode.optional input.clientMutationId ) ]
...
type alias UserStatusOrderRequiredFields =
    { field : Api.GitHub.Enum.UserStatusOrderField.UserStatusOrderField
    , direction : Api.GitHub.Enum.OrderDirection.OrderDirection
    }
...
encodeUserStatusOrder input =
    Encode.maybeObject
        [ ( "field", Encode.enum Api.GitHub.Enum.UserStatusOrderField.toString input.field |> Just ), ( "direction", Encode.enum Api.GitHub.Enum.OrderDirection.toString input.direction |> Just ) ]
